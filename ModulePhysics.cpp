...
bool ModulePhysics::Start()
{
	...
	world->SetContactListener(b2ContactListener*)// TODO 3: You need to make ModulePhysics class a contact listener
...
bool PhysBody::Contains(int x, int y) const
{
	...
	b2Vec2 point;
	point.Set(PIXEL_TO_METERS(x), PIXEL_TO_METERS(y));

	for (b2Fixture* fixture = body->GetFixtureList(); fixture != NULL; fixture = body->GetFixtureList()->GetNext())
	{
...
int PhysBody::RayCast(int x1, int y1, int x2, int y2, float& normal_x, float& normal_y) const
{
	...
	for (b2Fixture* fixture = body->GetFixtureList(); fixture != NULL; fixture = body->GetFixtureList()->GetNext())
	{
		ret = fixture->RayCast(output, input, 0);
	}
...
{
	PhysBody* p1 = (PhysBody*) contact->GetFixtureA()->GetBody()->GetUserData();

	PhysBody* p2 = (PhysBody*)contact->GetFixtureB()->GetBody()->GetUserData();
}
